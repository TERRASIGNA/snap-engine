 ...
 * @since BEAM 4.7
 */
public class ReprojectionImageGeometry {
    ...
    private ReprojectionImageGeometry() {
    }

    public ReprojectionImageGeometry(Rectangle bounds, CoordinateReferenceSystem mapCrs, AffineTransform image2map) {
        this.i2m = image2map;
    ...
    public static ReprojectionImageGeometry createTargetGeometry(Product sourceProduct, CoordinateReferenceSystem targetCrs,
                                                     Double pixelSizeX, Double pixelSizeY, Integer width,
                                                     Integer height,
                                                     Double orientation, Double easting, Double northing,
                                                     Double referencePixelX, Double referencePixelY) {
        Rectangle2D mapBoundary = createMapBoundary(sourceProduct, targetCrs);
        ReprojectionImageGeometry ig = new ReprojectionImageGeometry();
        ig.mapCrs = targetCrs;
    ...
    public static ReprojectionImageGeometry createCollocationTargetGeometry(Product targetProduct, Product collocationProduct) {
        ...
        return ReprojectionImageGeometry.createTargetGeometry(targetProduct,
